...
export const hardSourceWebpackPlugin = require('hard-source-webpack-plugin')
...
export const browserify = require('browserify')
export const vinylSourceStream = require('vinyl-source-stream')
...
export const stripify = require('stripify')
